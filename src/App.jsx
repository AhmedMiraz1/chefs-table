...
function App() {
  ...
  const handelAddToCurrentCooking = (current) => {
    setCurrentCook([...currentCook, current]);
    const index = cook.findIndex(itm => itm.id === current.id)
    const newCook = [...cook]
  ...
  return (
    <>
      <div className="container mx-auto px-8 lg:px-16 my-10 lg:my-16">
        ...
        <div>
          <h1 className="mt-24 mb-6 text-center text-2xl lg:text-5xl text-[#150B2B] font-medium lg:font-semibold">
            Our Recipes
          </h1>
          <p className="text-center text-[#150B2B99] font-normal mb-16 text-base">
            ...
            tantalize your taste buds and ignite your culinary creativity.{" "}
            <br /> From savory classics to innovative delights, each dish
